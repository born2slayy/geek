...
class PoseSaver:
    ...
    def save_current_pose(self, where: str):
        ...
        # filename = os.path.join('/home/jusang/Downloads/jamson/catkin_ws/src/IP010/ip010_teleop/config/', 'params' + '_' + str(self.current_file_location) + '.yaml')
        filename = os.path.join('/home/aidl/geekble_ws/src/IP050_ROS/ip050_teleop/config', 'params' + '_' + str(self.current_file_location) + '.yaml')
...
class MainWindow(QMainWindow):
    def __init__(self, pose_saver):
        ...
        # 이미지를 불러오기
        pixmap = QPixmap('/home/jusang/Pictures/sample_ri_2.png')
        ...
        self.button3 = QPushButton('C 좌표에 저장')
        self.button3.clicked.connect(lambda: self.pose_saver.save_current_pose('c'))

        self.button4 = QPushButton('D 좌표에 저장')
        self.button4.clicked.connect(lambda: self.pose_saver.save_current_pose('d'))

        self.button5 = QPushButton('E 좌표에 저장')
        self.button5.clicked.connect(lambda: self.pose_saver.save_current_pose('e'))
